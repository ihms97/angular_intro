...
class ArfamedController {
    ...
    listgroup(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            database_1.default.query('select cod_prof,nombre_prof,apellido_prof,celular_prof,correo_prof,detalle_especialidad from profesional pf left JOIN especialidad es on pf.cod_prof = es.cod_especialidad', (err, result) => {
                if (err) {
                    throw err;
                }
                else {
